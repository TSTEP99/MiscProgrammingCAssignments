...
//IMPLEMENT ME
my_customer= Person(first_name,last_name);
customer_savings.set_interest_rate();
}
...
//IMPLEMENT ME
my_customer= Person(first_name,last_name);
customer_savings=SavingsAccount(init_savings_balance,monthly_savings_interest_rate);
}
...
//IMPLEMENT ME
	customer_savings.set_balance(customer_savings.get_balance()+ amount);
}
...
//IMPLEMENT ME
customer_savings.set_balance(customer_savings.get_balance()+customer_savings.get_balance()*customer_savings.get_interest_rate());
